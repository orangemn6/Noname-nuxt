let resolve,posix,consola,deepMerge,Sentry,Integrations,WebpackPlugin;_34e‍.x([["default",()=>SentryModule]]);_34e‍.w("path",[["resolve",["resolve"],function(v){resolve=v}],["posix",["posix"],function(v){posix=v}]]);_34e‍.w("consola",[["default",["consola"],function(v){consola=v}]]);_34e‍.w("deepmerge",[["default",["deepMerge"],function(v){deepMerge=v}]]);_34e‍.w("@sentry/node",[["*",null,function(v){Sentry=v}]]);_34e‍.w("@sentry/integrations",[["*",null,function(v){Integrations=v}]]);_34e‍.w("@sentry/webpack-plugin",[["default",["WebpackPlugin"],function(v){WebpackPlugin=v}]]);
...
/** @type {import('@nuxt/types').Module} */
               function SentryModule (moduleOptions) {
  const defaults = {
